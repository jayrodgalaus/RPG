...
var materialList = [
    ...
    {id: 3, mob: "angels", category:"material", consumable: true, name: "Corrupt ichor (S)", stat: "ATK", min: 5, max: 10}, //specialty
    ...
    {id: 11, mob: "dragons", category:"material", name: "Dragon horn", stat: "SPD", min: 5, max: 7},
    ...
    {id: 14, mob: "fallen", category:"material", consumable: true, name: "Corrupt ichor (A)", stat: "ATK", min: 3, max: 5},
    {id: 15, mob: "fallen", category:"material", consumable: true, name: "Corrupt ichor (B)", stat: "SPD", min: 3, max: 5},
    {id: 16, mob: "fallen", category:"material", consumable: true, name: "Corrupt ichor (C)", stat: "DEF", min: 3, max: 5},
    {id: 17, mob: "fallen", category:"material", consumable: true, name: "Corrupt ichor (D)", stat: "HP", min: 3, max: 5},
    {id: 18, mob: "fallen", category:"material", consumable: true, name: "Bloodlust", stat: "ATK", min: -3, max: 10}, //specialty 
    {id: 19, mob: "generic", category:"material", consumable: true, name: "Madness", stat: "ATK", min: -2, max: 5}, //specialty
...
function rollMaterialDrop(bonus=0) {
    ...
    if(midDungeons.includes(currentDungeon.species)) bonus+= 0.1;
    if(lateDungeons.includes(currentDungeon.species)) bonus+= 0.2;
    if(lastDungeon.includes(currentDungeon.species)) bonus+= 0.3;
    bonus += currentFloor / 100;
